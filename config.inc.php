...
$_DVWA = array();
$_DVWA[ 'db_server' ]   = getenv("DATABASE_SERVER") ?: "127.0.0.1";
$_DVWA[ 'db_database' ] = getenv("DATABASE_NAME") ?: "dvwa";
$_DVWA[ 'db_user' ]     = getenv("DATABASE_USERNAME") ?: "dvwa";
$_DVWA[ 'db_password' ] = getenv("DATABASE_PASSWORD") ?: "dvwa";
$_DVWA[ 'db_port'] = '3306';
